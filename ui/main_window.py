...
"}")
        ...
        self.explain_title.setStyleSheet(u"font: 900 20pt \"江城斜宋体 900W\";")
...
#
#
#         self.verticalLayout_7.addWidget(self.Class_top)  # 添加横线
#
...
#
#         self.horizontalLayout_3.addWidget(self.Class_QF) # 横向框组合添加类别检测窗口
...
"}")
        ...
        # self.verticalLayout_22.addWidget(self.Save_QF) # 阈值框的位置添加
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"by Derui", None))

        self.ToggleBotton.setText(QCoreApplication.translate("MainWindow", u"隐藏", None))

        self.src_file_button.setText(QCoreApplication.translate("MainWindow", u"   图片视频检测", None))
        self.src_cam_button.setText(QCoreApplication.translate("MainWindow", u"   摄像头检测", None))
        self.src_rtsp_button.setText(QCoreApplication.translate("MainWindow", u"   屏幕实时检测", None))
        self.src_graph_button.setText(QCoreApplication.translate("MainWindow", u"  查看检测结果", None))
        self.src_lock_button.setText(QCoreApplication.translate("MainWindow", u"  查看信息记录", None))
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"基于YOLOv8的烟雾火焰检测系统", None))
        ...
        # 二级标题 暂定
        # self.char_label.setText(QCoreApplication.translate("MainWindow", u"暂未发现目标", None))

        # self.label_5.setText(QCoreApplication.translate("MainWindow", u"危险类别数", None))
        # self.Class_num.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"烟火目标数", None))
        ...
        self.status_bar.setText(QCoreApplication.translate("MainWindow", u"欢迎使用烟雾火焰检测系统!", None))
