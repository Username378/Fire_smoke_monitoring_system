...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def open_det_file(self):
        ...
        # 定义文件夹路径
        folder_path = r"E:\application\Security_monitoring_system\pre_result"
    ...
    def open_det_txt_file(self):
        ...
        # 定义文件夹路径
        folder_path_txt = r"E:\application\Security_monitoring_system\pre_labels"
    ...
    #         DialogOver(parent=self, text="数据统计图已经开启啦！", title="不能重复开启", flags="danger")
    #         return
    ...
    def change_val(self, x, flag):
        ...
        #     self.show_status('警报阈值设置: %s ' % str(x))
        #     self.smoke_threshold = x  # ms
